...
ax2.bar(ind, (but_row - np.mean(data, axis=1)) / np.std(data, axis=1), width, color='b')
ax2.bar(ind + width, (pen_row - np.mean(data, axis=1)) / np.std(data, axis=1), width, color='y')
ax2.bar(ind + 2 * width, (met_row - np.mean(data, axis=1)) / np.std(data, axis=1), width, color='r')
ax2.bar(ind + 3 * width, (random_row - np.mean(data, axis=1)) / np.std(data, axis=1), width, color='cyan')
ax2.grid()
