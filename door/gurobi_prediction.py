...
top = [
    ...
    [5, 13, 18, 39, 57, 58, 61, 72, 74, 77, 81, 85, 91, 98, 112, 118, 141, 202, 212, 214],
    [5, 18, 39, 40, 52, 57, 58, 61, 64, 72, 74, 77, 81, 85, 91, 98, 112, 118, 119, 126, 127, 172, 202, 212, 214]
]
top = np.asarray(top)
...
im = ax2.imshow(np.transpose(results), cmap=validation.cmap, interpolation='none', aspect='auto')
...
pl.savefig("../figures/gurobi_door_performance_" + datetime.datetime.now().strftime("%Y_%m_%d") + ".png")