...
#feature_list = np.array([5, 13, 18, 39, 57, 58, 61, 72, 74, 77, 81, 85, 91, 98, 112, 118, 141, 202, 212, 214]) #20
...
toolbox.plot_fingerprints(title, odorants[feature_list], data[:, feature_list], ors, path, "DoOR units")
