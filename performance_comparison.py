...
gscore = load_csv("results/g_scores_gauss_l_4.csv")
gtimes = load_csv("results/g_times_gauss_l_4.csv")
...
pl.plot(np.arange(1, 16, 0.2), np.arange(1, 16, 0.2) ** 2, 'm', linewidth=3, alpha=.3)
pl.plot(np.arange(1, 16, 0.2), np.arange(1, 16, 0.2) ** 3, 'r', linewidth=3, alpha=.3)
pl.legend(["BE feature", "BE data", "Gurobi feature", "Gurobi data", "$n^2$", "$n^3$"], fancybox=True, loc=0)
pl.xlim(1, 16)
pl.ylim(0, 1000)
